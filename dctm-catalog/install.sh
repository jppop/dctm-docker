...
cp $SOURCE/documentum/bam/2.2/bam-server.war $TARGET/dctm-bam/bundles/

echo "Copying BPS bundle"
cp $SOURCE/documentum/bps/2.2/bps.war $TARGET/dctm-bps/bundles/
...
cp $SOURCE/documentum/content-server/7.1/CS_7.1.0260/*.* $TARGET/dctm-base/bundles/patch/

echo "Copying Repository bundle"
cp -r $SOURCE/documentum/content-server/7.1/dars $TARGET/dctm-cs/bundles/dars
cp $SOURCE/documentum/process-engine/2.2/Process_Engine_linux.tar $TARGET/dctm-cs/bundles/
